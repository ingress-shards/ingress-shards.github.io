...
export default (env) => {
    const savePreprocessedDataToFile = env.savePreprocessedDataToFile === 'true';
        ...
        module: {
            rules: [
                ...
                },
                {
                    ...
                    use: [
                        {
                            loader: path.resolve(process.cwd(), 'scripts/preprocessor-loader.js'),
                            options: {
                                saveFile: savePreprocessedDataToFile,
                            },
                        },
                    ],
                },
